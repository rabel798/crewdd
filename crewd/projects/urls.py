...
urlpatterns = [
    ...
    path('improve-description/', views.improve_project_description, name='improve_description'),

    # Hackathon URLs
    path('hackathons/', dashboard_views.HackathonListView.as_view(), name='hackathon_list'),
    path('hackathons/<int:hackathon_id>/', dashboard_views.HackathonDetailView.as_view(), name='hackathon_detail'),
    path('hackathons/<int:hackathon_id>/register/<int:group_id>/', dashboard_views.RegisterForHackathonView.as_view(), name='register_for_hackathon'),
    path('my-hackathons/', dashboard_views.MyHackathonsView.as_view(), name='my_hackathons'),
]