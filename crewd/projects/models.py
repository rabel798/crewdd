...
class HackathonRegistration(models.Model):
    ...
    team = models.ForeignKey(Group, on_delete=models.CASCADE, related_name='hackathon_registrations')
    registered_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='hackathon_registrations')
    status = models.CharField(
        max_length=20,
        choices=[
